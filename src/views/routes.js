export default [
  {
    ...
    children: [
      ...
      { name: 'request.list', path: '/request/list', component: () => import('./Privacy/Requests/List') },
      { name: 'request.export', path: '/request/export/:requestID?', component: () => import('./Privacy/Requests/Export') },
      { name: 'request.deletion', path: '/request/deletion/:requestID?', component: () => import('./Privacy/Requests/Deletion') },
    ],
  },
